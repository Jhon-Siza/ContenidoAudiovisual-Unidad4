...
import controlador.AudiovisualController;
...
public class PruebaAudiovisual {
    public static void main(String[] args) {
        ...
        ArchivoManager.guardar(lista);

        System.out.println("--- SISTEMA DE GESTIoN AUDIOVISUAL ---");
        System.out.println();

        AudiovisualController controller =
        new AudiovisualController();

for (ContenidoAudiovisual c : lista) {
    controller.mostrarContenido(c);
}
    }
}